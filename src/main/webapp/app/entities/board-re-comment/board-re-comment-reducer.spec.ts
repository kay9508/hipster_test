...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOARDRECOMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOARDRECOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOARDRECOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOARDRECOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOARDRECOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOARDRECOMMENT actions', async () => {
      const expectedActions = [
        {
