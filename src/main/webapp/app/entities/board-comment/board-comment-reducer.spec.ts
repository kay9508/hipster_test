...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOARDCOMMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_BOARDCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BOARDCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BOARDCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BOARDCOMMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BOARDCOMMENT actions', async () => {
      const expectedActions = [
        {
