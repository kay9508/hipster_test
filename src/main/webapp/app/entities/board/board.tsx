  ...
  return (
    <div>
      <h2 id="board-heading" data-cy="BoardHeading">
        <Translate contentKey="testApp.board.home.title">Boards</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="testApp.board.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/board/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="testApp.board.home.createLabel">Create new Board</Translate>
          </Link>
        </div>
      </h2>
        ...
        {boardList && boardList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="testApp.board.id">Id</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="testApp.board.title">Title</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('title')} />
                </th>
                ...
                <th className="hand" onClick={sort('delAt')}>
                  <Translate contentKey="testApp.board.delAt">Del At</Translate> <FontAwesomeIcon icon={getSortIconByFieldName('delAt')} />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="testApp.board.home.notFound">No Boards found</Translate>
            </div>
          )
        )}
      </div>
